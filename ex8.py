...
class block(nn.Module):
    ...
    def __init__(self, eqnum):
        ...
        self.conv1 =nn.Conv2d(6 * eqnum, eqnum, 1, stride=1, padding=0, groups=1)
    ...
    def forward(self, x):
        y=block.conv(x)
        y = F.selu(self.bn2(self.conv1(y)))
...
print('c={},step={},eqnum={},batchsize={}'.format(block.c,pde.steps,pde.eqnum,batchsize))
epoch = 400
...
for times in range(epoch):
    ...
    if sum_test>op:
        op=sum_test
        torch.save(net.state_dict(), 'withoutmid_step{}_c{}_eqnum{}batchsize{}'.format(pde.steps,block.c,pde.eqnum,batchsize))
