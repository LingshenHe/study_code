...
class pde(nn.Module):
    ...
    def __init__(self):
        ...
        self.linear = nn.Linear(14 * 14*pde.eqnum, 10)
...
pde.steps=6
pde.eqnum=32
print('c={},step={},eqnum={}'.format(block.c,pde.steps,pde.eqnum))
epoch = 350
batchsize = 128
...
trainset=torchvision.datasets.MNIST('/home/lshe/code_study/',
                                 train=True,transform=transforms.ToTensor(),download=False)
testset=torchvision.datasets.MNIST('/home/lshe/code_study/',
...
for times in range(epoch):
    ...
    if sum_test>op:
        op=sum_test
        torch.save(net.state_dict(), 'mnist_step{}_c{}_eqnum{}'.format(pde.steps,block.c,pde.eqnum))
