...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, pl
        anes, num_blocks, stride):
...
trainset=torchvision.datasets.CIFAR10(root='/home/lshe/code_study/',train=True,transform=transform_train
                                    ,download=False)
testset=torchvision.datasets.CIFAR10(root='/home/lshe/code_study/',train=False,transform=transform_test,download=False)
...
torch.save(net.state_dict(),path='resnet')
