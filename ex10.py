...
for times in range(epoch):
    ...
    if sum_test>op:
        op=sum_test
        torch.save(net.state_dict(), 'step{}_c{}_eqnum{}batchsize{}'.format(pde.steps,block.c,pde.eqnum,batchsize))
    print('prelu  c={},step={},eqnum={},batchsize={}'.format(block.c, pde.steps, pde.eqnum, batchsize))
